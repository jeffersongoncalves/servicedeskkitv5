...
return [
    ...
    'manifest' => [
        'name' => env('APP_NAME', 'ServiceDeskKit'),
        'short_name' => env('APP_NAME', 'ServiceDeskKit'),
        ...
        // were upscaled from android-icon-192x192.png as placeholders. Replace
        // them with assets rendered from a high-resolution master for crisp
        // install icons (and a proper maskable safe-zone).
        'icons' => [
            '36' => '0.75',
            '48' => '1.0',
            '72' => '1.5',
